...
{   
    ...
    $query="CREATE table if not exists  uploaded_files(sno int AUTO_INCREMENT primary key,send_from varchar(50),send_to varchar(50),fname varchar(50),size double,date TIMESTAMP Default CURRENT_TIMESTAMP)";
    ...
    elseif($_FILES['myfile']['size']>1000000)
    {
        ...
        if(move_uploaded_file($file,$destination))
        {
            ...
            if (mysqli_query($con, $sql))
            {
                ...
                echo "<br>Error is ".mysqli_error($con);
            }
        }
        else{
            echo "<script type=\"text/javascript\">
